...
from shared import Color, Vector2, GameObject, ObjectType
...
def main():
    ...
    while running:
        ...
        zoom_txt = font.render(f"Zoom: {camera.zoom_level:.2f} (Zmiana Z/X) / Prędkość: {speed_multiplier:.1f} (Zmiana scroll) / Ruch Strzałki i LPM", True, Color.WHITE)
